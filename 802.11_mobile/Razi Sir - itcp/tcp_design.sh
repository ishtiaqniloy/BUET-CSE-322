...
ns /home/ubuntu/ns2\ programs/itcp/tcp_design_for_802_11.tcl $r
echo "SIMULATION COMPLETE. BUILDING STAT......"
#awk -f rule_th_del_enr_tcp.awk 802_11_grid_tcp_with_energy_random_traffic.tr > math_model1.out
awk -f /home/ubuntu/ns2\ programs/itcp/rule_tcp_wireless.awk /home/ubuntu/ns2\ programs/raw_data/tcp_wireless.tr > /home/ubuntu/ns2\ programs/raw_data/tcp_wireless.out
...
#	echo -ne "Throughput:          $thr " > $output_file
	...
	echo "$val"
done < /home/ubuntu/ns2\ programs/raw_data/tcp_wireless.out
