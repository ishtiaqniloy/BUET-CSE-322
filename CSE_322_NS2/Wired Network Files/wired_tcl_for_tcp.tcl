...
puts "Simulation will run for $time_duration time"
...
for {set i 0} {$i < $num_node} {incr i} {
	...
	$ns duplex-link $node_($source_end) $node_($dest_end) 2Mb 10ms SFQ
